...
class WorldGenBootstrap:
    ...
    def __init__(
        ...
        Args:
            seed: String seed to convert to numeric
                (default: "VoxelTree" -> 1903448982)
        ...
        logger.info(
            f"WorldGenBootstrap initialized: seed={self.seed}, heap={java_heap}"  # noqa: E501
        )
    ...
    def generate_region_batch(
        ...
        if current_disk_usage > 5.0:
            logger.error(
                f"Disk space limit exceeded: {current_disk_usage:.1f}GB > 5.0GB"  # noqa: E501
            )
        ...
        try:
            ...
            if not success:
                logger.warning(
                    "Initial worldgen failed, attempting retry with reduced batch size"  # noqa: E501
                )
    ...
    def _run_worldgen_java(
        ...
        z_range: Tuple[int, int],  # noqa: E501
    ) -> bool:
        """
