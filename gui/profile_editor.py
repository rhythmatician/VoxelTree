...
class ProfileEditorDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self._add_int(w_form, "world.radius", "Radius (blocks)", world.get("radius", 512), 64, 16384)
        ...
        self._add_str(d_form, "data.voxy_dir", "Voxy Dir", data.get("voxy_dir", "../LODiffusion/run/saves"))
        ...
        self._add_float(d_form, "data.min_solid", "Min Solid Frac", data.get("min_solid", 0.02), 0.0, 1.0)
        ...
        self._add_str(t_form, "train.output_dir", "Output Dir", train.get("output_dir", "models/new_profile"))
        ...
        self._add_float(t_form, "train.lr", "Learning Rate", train.get("lr", 0.0001), 1e-6, 0.1, decimals=6)
        ...
        self._add_str(e_form, "export.output_dir", "Output Dir", export.get("output_dir", "production/new_profile"))
        ...
        self._add_str(dep_form, "deploy.target_dir", "Target Dir",
    ...
    def _add_int(self, form: QFormLayout, key: str, label: str, value: int, mn: int = 0, mx: int = 999999) -> None:
        w = QSpinBox()
        w.setRange(mn, mx)
    ...
    def _add_float(self, form: QFormLayout, key: str, label: str, value: float,
                   mn: float = 0.0, mx: float = 1.0, decimals: int = 4) -> None:
        w = QDoubleSpinBox()
