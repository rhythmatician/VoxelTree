...
class VoxelRenderer:
    ...
    def _render_single_voxel(self, voxel_data: np.ndarray, ax, title: str, alpha: float = 0.8):
        ...
        for block_id in unique_blocks:
            ...
            if len(positions[0]) > 0:
                ax.scatter(positions[0], positions[1], positions[2], c=color, s=20, alpha=alpha)
    ...
    def render_structure_overlay(
        ...
        if len(non_structure_positions[0]) > 0:
            ...
            ax.scatter(
                non_structure_positions[0],
                non_structure_positions[1],
                non_structure_positions[2],
                c=colors,
                s=20,
                alpha=0.5,
        ...
        if len(structure_positions[0]) > 0:
            ax.scatter(
                structure_positions[0],
                structure_positions[1],
                structure_positions[2],
                c="red",
                s=40,
                alpha=0.9,
                marker="^",
